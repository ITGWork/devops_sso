...
@section('title', 'รายชื่อหน่วยตรวจสอบผลิตภัณฑ์ (IB/CB)')
...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title">รายชื่อหน่วยตรวจสอบผลิตภัณฑ์ (IB/CB)</h3>
                        ...
                        <table class="table table-borderless" id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th width="20%" class="text-center">หน่วยตรวจสอบ</th>
                                    <th width="12%" class="text-center">เลขนิติบุคคล</th>
                                    <th width="15%" class="text-center">หมวดอุตสาหกรรม/สาขาที่ตรวจสอบได้</th>
