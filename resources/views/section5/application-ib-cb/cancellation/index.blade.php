            ...
            <div class="col-sm-12 col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">
                        ยกเลิกการเป็นหน่วยตรวจสอบการทำผลิตภัณฑ์อุตสาหกรรม (IB/CB)
                    </h3>
                        ...
                        <table class="table table-borderless" id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">ประวัติราชกิจจานุเบกษา</th>
    ...
    <script>
        ...
        $(function () {
            var table = $('#myTable').DataTable({
                ...
                stateSave: false,
                ajax: {
                    "url": '{!! url('/request-section-5/application-ibcb/cancellation/data_list') !!}',
                    "dataType": "json",
                    "data": function(d) {
