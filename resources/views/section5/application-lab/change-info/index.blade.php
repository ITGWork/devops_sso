            ...
            <div class="col-sm-12 col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">
                        เปลี่ยนแปลงข้อมูลห้องปฏิบัติการ
                    </h3>
                    ...
                    <div class="row box_filter">
                        <div class="col-md-6">
                            ...
                            <div class="form-group col-md-10">
                                {!! Form::text('filter_search', null, ['class' => 'form-control', 'placeholder'=>'ค้นหาจาก รหัสห้องปฏิบัติการ/ชื่อ/เลขผู้เสียภาษี']); !!}
                            </div>
                        </div>
                        ...
                        <table class="table table-borderless" id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">รหัส / ชื่อห้องปฏิบัติการ</th>
    ...
    <script>
        ...
        $(function () {
            var table = $('#myTable').DataTable({
                ...
                stateSave: false,
                ajax: {
                    "url": '{!! url('/request-section-5/application-lab/change-info/data_list') !!}',
                    "dataType": "json",
                    "data": function(d) {
                ...
                columns: [
                    ...
                    { data: 'lab_info',          name: 'lab_name', searchable: false, orderable: false },
                    { data: 'lab_address_col',   name: 'lab_address', searchable: false, orderable: false },
