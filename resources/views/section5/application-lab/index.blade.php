    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ระบบคำขอรับการแต่งตั้งเป็นผู้ตรวจสอบการทำผลิตภัณฑ์อุตสาหกรรม (LAB)</h3>

                    <div class="pull-right">
                        <a class="btn btn-pink" href="{{ url('/dashboard/request-section-5') }}">
                            {{-- หน้าหลักคำขอมาตรา 5 --}}
                            <i class="fa fa-home"></i>
                        </a>
        
                        <a class="btn btn-danger" href="{{ url('/request-section-5/application-lab/cancellation') }}">
                            ยกเลิกการแต่งตั้ง
                        </a>
                        <a class="btn btn-warning" href="{{ url('/request-section-5/application-lab/change-info') }}">
                            เปลี่ยนแปลงข้อมูล
                        </a>
                        @if($hasRegisteredLab)
                            <a class="btn btn-info" href="{{ url('/request-section-5/labs') }}">
                                เพิ่มขอบข่าย/ลดขอบข่าย
                            </a>
                        @else
                            <a class="btn btn-success" href="{{ url('/request-section-5/application-lab/create') }}">
                                <i class="icon-plus"></i> ยื่นคำขอ
                            </a>
                        @endif
                    </div>
                    ...
                    <div class="row box_filter">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group col-md-10">
                                {!! Form::select('filter_state', App\Models\Section5\ApplicationLabStatus::pluck('title', 'id')->all(), null, ['class' => 'form-control', 'placeholder'=>'เลือกสถานะ']); !!}
                            </div>
                        </div>
                        ...
                        <table class="table table-borderless" id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th width="20%" class="text-center">ชื่อห้องปฎิบัติการ<br>ผู้ยื่นคำขอ</th>
                                    <th width="14%" class="text-center">เลขผู้เสียภาษี</th>
                    ...
                    @include ('section5.application-lab.modals.modal-cancel')
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                order: [[6, 'desc']],
                ajax: {
                    "url": '{!! url('/request-section-5/application-lab/data_list') !!}',
                    "dataType": "json",
                    "data": function (d) {
                ...
                columns: [
                    ...
                    { data: 'applicant_name', name: 'applicant_name', orderable: true },
                    { data: 'applicant_taxid', name: 'applicant_taxid', orderable: true },
                    { data: 'standards', name: 'standards', orderable: true },
                    { data: 'creater', name: 'creater', orderable: true },
                    { data: 'application_date', name: 'application_date', orderable: true },
                    { data: 'status_application', name: 'status_application', orderable: true },
            ...
            $('body').on('click', '.btn_delete', function(){
                ...
                $('#myModalLabel').text('ยกเลิกยื่นคำขอเป็นผู้ตรวจ #');
                ...
                if( id != ''){
                    ...
                    $('#myModalLabel').text('ยกเลิกยื่นคำขอเป็นผู้ตรวจ #'+id);
            ...
            $('body').on('click', '#btn_delete_save', function(){
                ...
                if( id != '' && remarks_delete != ''){
                    ...
                    if( confirm("Confirm delete?") ){
                        ...
                        $.ajax({
                            method: "POST",
                            url: "{{ url('/request-section-5/application-lab/delete_update') }}",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                "id": id,
